...
import beans.DepartamentoBeanRemote;
...
public class DepartamentoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String departamento = dataJSON.getJsonString("DEPARTAMENTO").getString();
            resposta = bean.departamentoBean(departamento) ? "Salvo com sucesso!" : "Ops, algo deu errado!";
