...
public class CategoriaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String categoria = dataJSON.getJsonString("CATEGORIA").getString();
            int departamento = dataJSON.getJsonNumber("CDEPARTAMENTO").intValue();
            resposta = bean.categoriaBean(categoria, departamento) ? "Salvo com sucesso!" : "Ops, algo deu errado!";
